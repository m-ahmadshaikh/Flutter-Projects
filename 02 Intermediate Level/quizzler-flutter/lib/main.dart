  ...
  void checkUserAnswer(bool userPickedAnswer) {
    setState(() {
      if (quizBrain.getQuestionAnswer() == userPickedAnswer) {
        quizBrain.addScore(Icon(Icons.check, color: Colors.green));
      } else {
        quizBrain.addScore(Icon(Icons.close, color: Colors.red));
      }
      if (quizBrain.getLength()[0] - 1 == quizBrain.getLength()[1]) {
        Alert(
                context: context,
                title: "Finished",
